...
+ [Maven: add a dependency to a jar by relative path - StackOverflow](http://stackoverflow.com/questions/2229757/maven-add-a-dependency-to-a-jar-by-relative-path)
